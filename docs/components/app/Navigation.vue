...
const { data: latestRelease } = await useFetch<{ name: string, html_url: string }>('https://api.github.com/repos/oyedejioyewole/nuxt-bootstrap-icons/releases/latest', { pick: ['name', 'html_url'] })
</script>
